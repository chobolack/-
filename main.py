...
# 上拉桿最大應力點
abc = function.abc(after[7], Pipe_width, pipe[1], after[1], after[8], pipe[0])
# 銷直徑最小值
...
print("")
print("    Bending:")
print(f"    σmax = {round(abc[0], num)} MPa")
print("")
print("    Axial load:")
print(f"    σ = {round(abc[1], num)} MPa")
print("")
print(f"    σ = σmax + σ = {round(abc[2], num)} MPa")
print("")
